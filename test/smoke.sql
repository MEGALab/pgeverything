...
DO $$ DECLARE n int; BEGIN
  ...
  RAISE NOTICE '[2/6] JSONB document   ok';
END $$;
...
DO $$ DECLARE b timestamptz; BEGIN
  ...
  DROP TABLE t_ts;
  RAISE NOTICE '[4/6] Time-series      ok';
END $$;
...
DO $$ DECLARE msg_id bigint; got jsonb; BEGIN
  ...
  RAISE NOTICE '[5/6] Pub/Sub (pgmq)   ok';
END $$;
...
DO $$ DECLARE nearest text; BEGIN
  ...
  RAISE NOTICE '[6/6] Vector           ok';
END $$;

\echo '=== PGEverything: all six capabilities verified ==='
